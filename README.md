...
# 🧹 Markdown Cleanup Challenge – Fork & Fix It!

This repository contains a deliberately broken documentation file: `BROKEN_GUIDE.md`. Your challenge is to:

### 🔍 Identify and Fix Issues Such As:
- Spelling and grammar errors
- Incorrect command usage (`git clon`, `git commt`, etc.)
- Improper bullet or step numbering
